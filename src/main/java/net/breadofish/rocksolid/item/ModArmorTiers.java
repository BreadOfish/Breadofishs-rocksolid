...
public enum ModArmorTiers implements ArmorMaterial {
        ENDERITE("enderite", 40, new int[]{5, 8, 10, 3}, 5, SoundEvents.ARMOR_EQUIP_NETHERITE, 4.0F, 0.01F, () -> {
            return Ingredient.of(ModItems.enderiteingot.get());
        });
        ...
        public String getName() {
            ...
            return rocksolid.MODID + ":" + this.name;
        }
